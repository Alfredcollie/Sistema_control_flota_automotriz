...
class OrdenesCompraClienteApp:
    ...
    def inicializar_bd(self):
        global _SCHEMA_OC_CLIENTES_OK
        if _SCHEMA_OC_CLIENTES_OK: return
    ...
    def crear_interfaz(self):
        ...
        self.tbl_cli.column("arch", width=80, anchor="center")
        ...
        frame_paginacion = ctk.CTkFrame(f_derecha, fg_color="transparent")
        frame_paginacion.pack(fill="x", pady=(10, 0))
        ...
        # Iniciar Cargas
        self.parent_frame.after(100, self.cargar_cotizaciones_aprobadas)
    ...
    # 🚀 FIX: CARGA ASÍNCRONA + LAZY LOADING (Cero Congelamientos)
    def cargar_tabla(self, reset_pagina=False):
        ...
        texto = self.ent_busc_cli.get().strip().lower()
        offset = (self.pagina_actual - 1) * self.registros_por_pagina
        
        clave_cache = f"oc_clientes_{texto}_pag_{self.pagina_actual}"
